-- =====================================================
-- SYMBOLS CLEANUP AND RESEED ONLY
-- =====================================================

SET FOREIGN_KEY_CHECKS = 0;

-- Clean positions and trade history first
...
-- Insert all 70 symbols
INSERT INTO symbols (symbol, name, category_id, base_currency, quote_currency, contract_size, pip_size, min_lot, max_lot, lot_step, spread_markup, swap_long, swap_short, margin_requirement, is_active) VALUES
...
SELECT 'Symbols updated!' as Status;
